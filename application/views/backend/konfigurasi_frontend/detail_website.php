					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget jarviswidget-color-blueDark">
							...
							<div>
								...
								<?php
									$query = $this->db->query("SELECT * FROM umkm_web")->row();
								?>
									<form role="form" action="<?php echo base_url('backend/setting/web?go=process'); ?>" method="post" name="detail_web" id="detail_web" class="smart-form" enctype="multipart/form-data">
										<fieldset>          
											<div class="row">
