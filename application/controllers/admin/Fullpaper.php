		...
		//tampil atau tidak tampil
			 ...
			 if ($status_off) {				  				  
			  ...
			  // 		$CI = &get_instance();
				 ...
				 $pesan='Info: Fullpaper a.n. '.$nama.' dinyatakan TIDAK LOLOS, silakan cek kembali relevansi konten dengan tema seminar. Pansembio '.$tahun.'.';
			 ...
			 if ($status_on) {				  				  
			  ...
			  // 		$CI = &get_instance();
				 ...
				 // $pesan='Info: Fullpaper a.n. '.$nama.' telah diperiksa dan dinyatakan LOLOS, sampai jumpa di Solo '.date_to_id($this->account_model->setting('waktu')).'. Pansembio '.$tahun.'.';
				 $pesan='Info: Fullpaper a.n. '.$nama.' diterima untuk direview, Hasil review dikirimkan email. Pansembio '.$tahun.'.';
				 //   $infosms['DestinationNumber']=$hp;
				 //   $infosms['SenderID']='Modem-Biologi';
			 ...
			 if ($status_rev) {				  				  
			  ...
			  // 		$CI = &get_instance();
				 ...
				 $tahun='Info: Fullpaper a.n. '.$nama.' dinyatakan diterima dengan REVISI, silakan revisi dan upload lagi di sistem kami. Pansembio '.$tahun.'.';
				 //   $infosms['DestinationNumber']=$hp;
				 //   $infosms['SenderID']='Modem-Biologi';
