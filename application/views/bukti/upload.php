...
<html lang="en-us">
	...
	<body class=" fixed-header fixed-navigation">
		...
		<div id="main" role="main" style="margin-left:0px">
			...
			<center>
				<h3>Selamat Datang <b><?php echo $this->account_model->nama_peserta_gelar($no) ?></b>, Silakan Upload <font color="red">Bukti Transfer</font> Anda</h3>
				<br/>
				<form method="post" action="<?php echo base_url('bukti/prosesupload')?>" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $no ?>">
				<input type="file" name="filebukti" class="form-control" style="width:20%" required><br/>File yang dapat di upload hanya yang berekstensi <b>.pdf</b> atau <b>.jpg</b> atau <b>.png</b><br/><br/>
