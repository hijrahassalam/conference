...
<div id="main" role="main">
	...
	<div id="content" class="container">
		<div class="row" style="margin-top:2%">
			...
			<form method="POST" action="<?php echo base_url('daftar/login')?>" id="login-form" class="smart-form client-form">
								<header>
									<center>Welcome to <?php echo $query['web_judul']?> 2016</center>
								</header>
								...
								<footer>
									<a href="<?php echo base_url('daftar')?>" class="btn btn-danger">Register</a>
