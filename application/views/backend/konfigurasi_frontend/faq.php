    ...
    <div id="main" role="main">
				...
				<div class="row">
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false">
							...
							<!-- widget div-->
							<div>
								<a href="<?php echo base_url('backend/setting/faq?do=add'); ?>" class="btn bg-color-greenLight txt-color-white"> <i class="fa fa-lg fa-fw fa-plus"></i> Tambah</a><br /><br />
								<!-- widget edit box -->
								...
								<div class="widget-body no-padding">
									...
									<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
										...
										<?php   
										$n=1;
										$query = $this->db->query("SELECT * FROM umkm_faq ORDER BY status desc");
										foreach ($query->result_array() as $data) {
										?>
										
											<tr>
												<td class="center"><?php echo $n; ?></td>
												 <td class="center"><?php echo substr($data['pertanyaan'],0,150); ?></td>
												<td class="center"><?php echo substr($data['jawaban'],0,150); ?></td>
											
												<?php if( $data['status']=="1"){ ?>
												<td>
													<div class="btn-group">
															<a class="btn btn-success btn-sm" href="#"><i class="glyphicon glyphicon-ok icon-white"></i> Ditampilkan</a>
															<a class="btn btn-success dropdown-toggle btn-sm" data-toggle="dropdown" href="#"><span class="caret"></span></a>
															<ul class="dropdown-menu">
																<li><a href="<?php echo base_url('backend/setting/faq?status_off='.$data['id']); ?>">Sembunyikan</a></li>
															</ul>
													</div>
												</td>
												...
												<td>
													<div class="btn-group">
															...
															<ul class="dropdown-menu">
																<li><a href="<?php echo base_url('backend/setting/faq?status_on='.$data['id']); ?>">Tampilkan</a></li>
															</ul>
													</div>
												</td>
		...
		<script type="text/javascript">
			...
			function conf_del(id){
				...
				if(r) window.location.href = "<?php echo base_url('backend/setting/faq?do=delete&id='); ?>" + id;
			}
			function conf_edit(id){
				window.location.href = "<?php echo base_url('backend/setting/faq?do=edit&id='); ?>" + id;
			}
		</script>
