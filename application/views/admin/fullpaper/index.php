...
>													<th data-hide="phone, tablet" width="30%"><center>Judul</center></th>
													<th data-hide="phone, tablet" width="8%"><center>Bukti Bayar</center></th>
													<th data-hide="phone, tablet" width="8%"><center>Full Paper</center></th>
											...
											<tbody>
												...
												foreach ($query->result_array() as $row)
												{
													...
													<tr>
														...
														<td><?php if ($row['buktibayar']=="") {
														echo "Belum Upload</td>"; }
														else
														{
														?>
														<a href="<?php echo base_url('uploads/bukti/'.$tahun.'/'.$row['buktibayar'].'')?>" class="btn btn-primary btn-xs">Download</a></td>
														<?php
														}
														?>
														<td>
														<?php if ($row['fullpaper']=="") {
														echo "Belum Upload</td>"; }
														else
														{
														?>
														<a href="<?php echo base_url('uploads/fullpaper/'.$tahun.'/'.$row['fullpaper'].'')?>" class="btn btn-primary btn-xs">Download</a></td>
														<?php
														}
														?>
														<?php if($row['status_fullpaper']=="3"){ ?>
														<td>
															<div class="btn-group">
																	...
																	<ul class="dropdown-menu">
																		<li><a href="<?php echo base_url('admin/fullpaper?lolos_rev='.$row['no']); ?>">Revisi</a></li>
																		<li><a href="<?php echo base_url('admin/fullpaper?lolos_off='.$row['no']); ?>">Tidak Lolos</a></li>
																	</ul>
															</div>
														</td>

														<?php } else if ($row['status_fullpaper']=="2") { ?>
														<td>
															<div class="btn-group">
																	...
																	<ul class="dropdown-menu">
																		<li><a href="<?php echo base_url('admin/fullpaper?lolos_on='.$row['no']); ?>">Lolos</a></li>
																		<li><a href="<?php echo base_url('admin/fullpaper?lolos_off='.$row['no']); ?>">Tidak Lolos</a></li>
																	</ul>
															</div>
														...
														<?php } else if ($row['status_fullpaper']=="1") { ?>
														<td>
															<div class="btn-group">
        ...
        $(function(){
            $(document).on('click','#modalku',function(e){
                ...
                $.post('<?php echo base_url('admin/fullpaper/modal')?>',
