...
class Setting extends CI_Controller {
	...
	public function web(){
		...
		if (!$go){
			$this->load->view('backend/konfigurasi_frontend/detail_website');
		}
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$targetPath = $_SERVER['DOCUMENT_ROOT'].'/umkm/uploads/';
				...
				$this->db->update('umkm_web', $data);
				redirect(base_url('backend/setting/web'));
			}
		}
	}
