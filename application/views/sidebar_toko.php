<div class="col-md-3">
              <aside class="sidebar">
                ...
                <div class="toogle">
                  <section class="toggle active"><label>Profil Toko</label>
                  <ul class="simple-post-list">
                    <li>
                      <div class="post-image">
                      <div class="img-thumbnail">
                        <a href="<?php echo base_url('toko/'.$toko['user_id'].'')?>">
						<?php
						if ($toko['toko_gambar']=="")
						{
							$toko['toko_gambar']="14343751401434088576No_Image_Available.png";
						}
						?>
                          <img alt="<?php echo $toko['toko_nama']?>" width="60" height="60" class="img-responsive" src="<?php echo base_url('uploads/toko/'.$toko['toko_gambar'].'')?>">
                        </a>
                      </div>
                    </div>
                    <div class="post-info">
                      <a href="<?php echo base_url('toko/'.$toko['user_id'].'')?>"><?php echo $toko['toko_nama']?></a>
                      <br/>
                      <div class="post-meta">
                      <b>Terverifikasi</b>
                      </div>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><?php echo $toko['toko_alamat'] ?></td>
                  </tr>
                  <tr>
                    <td><i class="fa fa-phone"></i></td>
                    <td>&nbsp;</td>
                    <td><?php echo $akun['akun_hp'] ?></td>
                  </tr>
                  </table>
                  <hr style="margin:5px">
                  </section>
                ...
                <section class="toggle active">
                  <label>Daftar Nama Industri Terbaru</label>
