...
<?php
	...
	<head>
		...
		<meta name="keywords" content="sembio, fkip, uns" />
		<meta name="description" content="Seminar Biologi FKIP UNS">
		<meta name="author" content="ICT FKIP UNS, Adriyanto Prasetyo">
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url('asset/asset_admin/css/font-awesome.min');?>">
		...
		<!-- FAVICONS -->
		<link rel="shortcut icon" href="<?php echo base_url('asset/asset_home/img/kemdikbud.png');?>" type="image/x-icon">
		<link rel="icon" href="<?php echo base_url('asset/asset_home/img/kemdikbud.png');?>" type="image/x-icon">
	...
	<div id="content" class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><center>
				<h1 class="txt-color-red login-header-big">Selamat Datang di SIM <?php echo $query['web_judul']?> </h1></center>
				<br/>
				<center>
				<div class="well no-padding" style="width:40%">
					...
					<form action="<?php base_url('login');?>" method="post" id="login-form" class="smart-form client-form">
						...
						<footer>
							<button type="submit" class="btn btn-primary" style="background:#08C;border-color:#08C">
								Masuk
							</button>
						</footer>
					</form>
