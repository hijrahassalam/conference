<?php
if ($data['status_bukti']=="2" && $data['status_fullpaper']=="3")
{
	?>
...
<div style="text-align:right;padding-right:10px;font-size:11pt">Surakarta, 31 Juli 2018</div>
<table style="width:50%;font-size:11pt">
<tr>
	<td style="width:10%">No</td>
	<td style="width:2%">:</td>
	<td style="width:85%">17 /IV/SEMBIO-XV/2018</td>
</tr>
<tr>
	<td>Lamp.</td>
	<td>:</td>
...
<div style="padding-left:40px">
	<table style="width:70%">
		...
		<tr>
			...
			<td style="font-size:11pt">:</td>
			<td style="font-size:11pt">07.30 - Selesai</td>
		</tr>
		<tr>
...
<p style="font-size:11pt;align:justify">Demikian pemberitahuan dan sekaligus undangan kami. Terima kasih atas perhatian Bapak/Ibu/Sdr.</p>
<div style="padding-left:300px"><img src="uploads/ttd.PNG" /></div>
</page>
...
<table style="width:100%">
	...
	<tr>
		<td style="width:45%;border:2px solid #000; text-align:center;height:200px;font-size:14px">SEMINAR NASIONAL XV<br/>PENDIDIKAN BIOLOGI<br/>FKIP UNIVERSITAS SEBELAS MARET<br/><hr><br/><i>Inovasi Biologi dan Pembelajarannya di Era Keterbukaan Pengetahuan</i><br/><br/><br/><i>Surakarta, 04 Agustus 2018</i><br/><br/><br/><u><font style="font-size:16px"><b><?php echo $this->account_model->nama_peserta_gelar($data['no'])?></b></font></u><br/><b>
			<?php
    if ($data['is_pemakalah']=="1")
    	...
    	else
    	{
    		...
    		?></b><br/><br/><b>No Peserta : <?php echo $noo ?></b><br/><br/>
    	<div style='align:right;display:inline;padding-right:120px'><img src="uploads/stempel.png" style="width:75px;height:75px" /></div><br/>
    	<div style='text-align:left;display:inline;margin-left:-150px;width:60px;height:80px;border:1px;border-collapse:collapse;margin-top:-80px'><?php echo ($data['photo']!='user.jpg') ? "<img src='".base_url('uploads/photo/'.str_replace(' ','%20',$data['photo']).'')."' width='100%;height:100%'>" : ""?></div><br/><br/></td>
		<td style="width:10%;vertical-align:middle;text-align:center">L<br>I<br>P<br>A<br>T<br>&nbsp;<br>D<br>I<br>&nbsp;<br>S<br>I<br>N<br>I</td>
		<td style="width:45%;border:2px solid #000;padding:8px"><div style='text-align:center;font-size:14px'>SEMINAR NASIONAL XV<br/>PENDIDIKAN BIOLOGI<br/>FKIP UNIVERSITAS SEBELAS MARET</div><br/><br/>
		<table style="width:100%;" class="tg">
			...
			<tr>
				<td>09.15 - 10.15</td>
				<td>Sesi 1, <b>Pembicara Kunci</b> <br/>(BELMAWA DIKTI)</td>
			</tr>
			<tr>
				<td>10.15 - 10.50</td>
...
if ($jum>0)
{
	for($i=0;$i<$jum;$i++)
	{
		...
		<table style="width:100%">
		<tr>
			<td style="width:45%;border:2px solid #000; text-align:center;height:200px;font-size:14px">SEMINAR NASIONAL XV<br/>PENDIDIKAN BIOLOGI<br/>FKIP UNIVERSITAS SEBELAS MARET<br/><hr><br/><i>Inovasi Biologi dan Pembelajarannya di Era Keterbukaan Pengetahuan</i><br/><br/><br/><i>Surakarta, 04 Agustus 2018</i><br/><br/><br/><u><font style="font-size:16px"><b>
	    <?php
	    $gelar1="";
	    $gelar2="";
    ...
    if ($data['is_pemakalah']=="1")
    	...
    	else
    	{
    		...
    		?></b><br/><br/><b>No Peserta : <?php echo $noo ?></b><br/><br/>
    	<div style='align:right;display:inline;padding-right:120px'><img src="uploads/stempel.png" style="width:75px;height:75px" /></div><br/>
    	<div style='text-align:left;display:inline;margin-left:-150px;width:60px;height:80px;border:1px;border-collapse:collapse;margin-top:-80px'></div><br/><br/></td>
		<td style="width:10%;vertical-align:middle;text-align:center">L<br>I<br>P<br>A<br>T<br>&nbsp;<br>D<br>I<br>&nbsp;<br>S<br>I<br>N<br>I</td>
		<td style="width:45%;border:2px solid #000;padding:8px"><div style='text-align:center;font-size:14px'>SEMINAR NASIONAL XV<br/>PENDIDIKAN BIOLOGI<br/>FKIP UNIVERSITAS SEBELAS MARET</div><br/><br/>
		<table style="width:100%;" class="tg">
			<tr>
...
?>
<br/><br/>
<div style="font-size:14px;color:#fff;background-color: #1f8ff1;padding:5px"><b>NB:</b> Mohon dicetak di kertas sampul warna putih kemudian dipotong dan dilipat serta dibawa saat registrasi seminar</div>
</page>
<?php
}
else
