...
<div id="main" role="main">
	...
	<div id="content" class="container">
		<div class="row" style="margin-top:2%">
			...
			<?php
			if (date("Y-m-d") < $this->account_model->setting('daftar_reg'))
			{
				echo "<br><center><h3>Pendaftaran Sudah Ditutup. Selamat Berjumpa tanggal ".date_to_id($this->account_model->setting('waktu'))." di Solo</h3><br/><a href='".base_url('')."' class='btn btn-warning'>Ke Halaman Utama</a></center>";
			}
			else
			{
				?>
			<form method="POST" action="<?php echo base_url('index.php/daftar/submit')?>" id="frmreg" class="smart-form client-form">
			<fieldset>
				<div class="row">
				<section class="col col-6">
					<label class="label">Nama Depan</label>
						<label class="input"><i class="icon-append fa fa-user"></i>
							<input type="text" id="firstnama" placeholder="Nama Depan" name="firstnama" required>
				...
				<section class="col col-6">
					<label class="label">Nama Belakang</label>
						<label class="input"><i class="icon-append fa fa-user"></i>
							<input type="text" id="lastnama" placeholder="Nama Belakang" name="lastnama" required>
							<b class="tooltip tooltip-top-right">
								<i class="fa fa-warning txt-color-teal"></i> 
				...
				<section>
						...
						<label class="input"><i class="icon-append fa fa-user"></i>
							<input type="text" placeholder="Nama Institusi" name="institusi" id="institusi" required>
							<b class="tooltip tooltip-top-right">
								<i class="fa fa-warning txt-color-teal"></i> 
				...
				<section>
						...
						<label class="input"><i class="icon-append fa fa-user"></i>
							<input type="text" placeholder="Nomor HP Anda" name="nohp" onkeypress="return isNumberKey(event)" id="nohp" required>
							<b class="tooltip tooltip-top-right">
								<i class="fa fa-warning txt-color-teal"></i> 
