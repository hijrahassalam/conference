...
<p style="line-height:130%;margin-top:0px;text-align:justify;font-size:11pt;margin-bottom:0px">Kami beritahukan bahwa berdasarkan pendaftaran sebagai peserta Seminar Nasional XVI Pendidikan Biologi yang telah Bapak/Ibu/Sdr lakukan, dengan ini kami undang Bapak/Ibu/Sdr untuk hadir pada seminar tersebut, yang akan diselenggarakan pada :</p>
...
<table style="width:100%">
    	<?php $noo=$data['nourut']; ?>
	<tr>
		<td style="width:45%;border:2px solid #000; text-align:center;height:200px;font-size:14px">SEMINAR NASIONAL XVI<br/>PENDIDIKAN BIOLOGI<br/>FKIP UNIVERSITAS SEBELAS MARET<br/><hr><br/><i>Inovasi Biologi dan Pembelajarannya di Era Keterbukaan Pengetahuan</i><br/><br/><br/><i>Surakarta, <?php echo date_to_id($this->account_model->setting('waktu'))?></i><br/><br/><br/><u><font style="font-size:16px"><b><?php echo $this->account_model->nama_peserta_gelar($data['no'])?></b></font></u><br/><b>
			<?php
