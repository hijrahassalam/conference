...
<div id="main" role="main">
	...
	<div id="content" class="container">
		<div class="row" style="margin-top:2%">
			...
			<form method="POST" action="<?php echo base_url('forgotpass')?>" id="login-form" class="smart-form client-form" onsubmit="return confirm('Are you sure for reset password ?');">
								<header>
									<center>Welcome to <?php echo $query['web_judul']?> <?php echo $this->account_model->setting('tahun')?></center>
								</header>
								...
								?>
									<section>
										<label class="label">Please fill your Email or Phone Number</label>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" name="key" required>
											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Please fill your Email or Phone Number</b></label>
									</section>
								</fieldset>
								<footer>
